...
class xmlHandler(sax.ContentHandler):
    def __init__(self, g_DataQueue, g_FinishRead):
        ...
        self.patterns.append(re.compile("[\[\]<>`~$\^&*=|%@(){},:\"/'\\\\]"))  # 一些替换
        # 预编译一部分  文章无用section
        self.patterns_sect = []
...
if __name__ == '__main__':
    ...
    #                      args=(g_DataQueue, g_FinishRead, "../result/step1.1.1_bigram_V1.m", None))
    # procRead.start()
    # procPhrase.start()
    # procPhrase.join()
    # procRead.join()
    ...
    # procRead = Process(target=readWikiXML, args=(g_DataQueue, g_FinishRead))
    # procPhrase = Process(target=trainPhrase,
    #                      args=(g_DataQueue, g_FinishRead, "../result/step1.1.2_trigram_V1.m", "../result/step1.1.1_bigram_V1.m"))
    # procRead.start()
    # procPhrase.start()
    # procPhrase.join()
    # procRead.join()
    ...
    #                      args=(g_DataQueue, g_FinishRead, "../result/step1.1.3_WikiVocabulary_V1.json",
    #                            "../result/step1.1.1_bigram_V1.m", "../result/step1.1.2_trigram_V1.m"))
    # procRead.start()
    # procPhrase.start()
    # procPhrase.join()
    # procRead.join()
...
# In[] 解决-的问题
#    di={}
#    with codecs.open("../result/step1.1.3_WikiVocabulary_V1.json","r",encoding="utf-8") as fr:
#        odict=json.load(fr)
#        c=0
...
#            else:
#                di[t]=value
#    with codecs.open("../result/step1.1.3_WikiVocabulary_V11.json","w",encoding="utf-8") as fw:
